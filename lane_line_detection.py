...
def calculate_control_signal(img, signs, lst_car, distance, draw=None):
    ...
    object_left, object_right = find_left_right_points(0.1, pred_birdview, draw=draw) #cam thang nao chinh ROI
    ...
    #if go through sign then discard global sign_lst
    if len(sign_list) > 0:
    ...
    if time_to_turn and check_distance:
        ...
        return angle_turn, check_to_discard, brake
    ...
    return angle_degrees, check_to_discard, brake
